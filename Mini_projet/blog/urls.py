...
from blog.views import HomeView, about,ArticleDetailView, DeleteArticle,EditArticle, EditCategory, contact, Admin_dashboaord,DeleteCategory,  User_dashboaord, RegisterView, LoginView, VerifyEmailView
